...
class UpdateColorRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'name_ar'     => ['required','string','max:255', Rule::unique('colors', 'name_ar')->ignore($color->name_ar,'name_ar')->whereNull('deleted_at')] ,
            'name_en'     => ['required','string','max:255', Rule::unique('colors', 'name_en')->ignore($color->name_en,'name_en')->whereNull('deleted_at')] ,
        ];
