...
let initCarsChart    = () => {
        ...
        if (carsChart) {
            ...
            new ApexCharts(carsChart, {
                series: [{name: __("Cars number"), data: carsMonthlyRate['data'] }],
                chart: {
                    fontFamily: "inherit",
                    type: "area",
...
let initOrdersChart  = () => {
    ...
    if (ordersChart) {
        ...
        new ApexCharts(ordersChart, {
            series: [{name: __("Orders number"), data: ordersMonthlyRate['data'] }],
            chart: {
                fontFamily: "inherit",
                type: "area",
...
let initClientsChart = () => {
        ...
        if (clientsChar) {
            ...
            new ApexCharts(clientsChar, {
                series: [{name: __("Clients number"), data: clientsMonthlyRate['data'] }],
                chart: {
                    fontFamily: "inherit",
                    type: "area",
