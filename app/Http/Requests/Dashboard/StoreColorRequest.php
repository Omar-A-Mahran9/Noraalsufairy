...
class StoreColorRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            'name_ar'     => ['required','string','max:255',  Rule::unique('colors', 'name_ar')->whereNull('deleted_at')] ,
            'name_en'     => ['required','string','max:255',  Rule::unique('colors', 'name_en')->whereNull('deleted_at')] ,
        ];
