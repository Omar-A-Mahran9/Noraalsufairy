...
<div class="card">
    ...
    <div class="card-body p-0">
        <!-- begin :: Form -->
        <form action="{{ route('dashboard.news.store') }}" class="form" method="post" id="submitted-form" data-success-message="{{ __('News added successfully') }}" data-redirection-url="{{ route('dashboard.news.index') }}">
            @csrf
            <!-- begin :: Card header -->
            <div class="card-header d-flex align-items-center">
                ...
                <div class="card-title">
                    <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                        ...
                        <input class="form-check-input mx-2" style="height: 28px;width:60px;" type="checkbox" name="highlighted_news" id="highlighted-checkbox" checked />
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title_ar" placeholder="example" />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title_en" placeholder="example" />
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea id="tinymce_description" name="description_ar" class="tinymce"></textarea>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea id="tinymce_description" name="description_en" class="tinymce"></textarea>
