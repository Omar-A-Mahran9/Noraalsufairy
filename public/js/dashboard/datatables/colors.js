        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if ( data !== null )
                            return `<img style="height:30px;width:30px" src="${getImagePathFromDirectory(data, 'Colors')}" class="me-3 rounded-circle" >`;
                        else
                            return "<h1>-</h1>"
                    }
                },
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 d-flex justify-content-between delete-row" data-row-id="${row.id}" data-type="${__('color')}">
                                       <span> ${__('Delete')} </span>
