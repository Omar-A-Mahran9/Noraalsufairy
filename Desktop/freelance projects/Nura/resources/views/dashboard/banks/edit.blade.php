                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 fv-row">
                            <div class="form-group row">
                                <label class="col-3 col-form-label fs-5 fw-bold"><i class="bi bi-dash-lg fs-8 mx-3"></i>{{__('Accept clients from other banks')}}</label>
                                <div class="col-8 col-form-label">
                                    <div class="radio-inline  d-flex justify-content-start">
                                        <div class="form-check form-check-custom form-check-solid mx-4">
                                            <input class="form-check-input" type="radio" @if($bank->accept_from_other_banks) checked @endif value="1" name="accept_from_other_banks" id="accept_from_other_banks_yes" wtx-context="6ABBB073-FB69-4058-8A50-6B4FFD240797">
                                            <label class="form-check-label" for="accept_from_other_banks_yes">
                                                {{__('Yes')}}
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mx-4">
                                            <input class="form-check-input" type="radio" @if(!$bank->accept_from_other_banks) checked @endif value="0" name="accept_from_other_banks" id="accept_from_other_banks_no" wtx-context="01DAA9FF-73CC-4456-8B56-E4272344A5D0">
