        ...
        $banksData = [
            [
                ...
                'sectors' => [
                    [
                        'id' => '2',
                        'transferred_benefit' => '0',
                        'non_transferred_benefit' => '0',
                        'support' => '105',
                        'advance' => '10',
                        'installment' => '2',
                    ...
                    [
                        'id' => '1',
                        'transferred_benefit' => '3',
                        'non_transferred_benefit' => '3',
                        'support' => '0',
                        'advance' => '5',
                        'installment' => '1',
                        'administrative_fees' => rand(1,5)
            ...
            [
                ...
                'sectors' => [
                    ...
                    [
                        'id' => '1',
                        'transferred_benefit' => '4',
                        'non_transferred_benefit' => '4',
                        'support' => '0',
                        'advance' => '20',
                        'installment' => '4',
                        'administrative_fees' => rand(1,5)
                    ...
                    [
                        'id' => '3',
                        'transferred_benefit' => '2',
                        'non_transferred_benefit' => '2',
                        'support' => '0',
                        'advance' => '30',
                        'installment' => '6',
                        'administrative_fees' => rand(1,5)
            ...
            [
                ...
                'sectors' => [
                    ...
                    [
                        'id' => '1',
                        'transferred_benefit' => '5.50',
                        'non_transferred_benefit' => '5.50',
                        'support' => '0',
                        'advance' => '35',
                        'installment' => '7',
                        'administrative_fees' => rand(1,5)
                    ...
                    [
                        'id' => '3',
                        'transferred_benefit' => '1',
                        'non_transferred_benefit' => '1',
                        'support' => '0',
                        'advance' => '0',
                        'installment' => '9',
                        'administrative_fees' => rand(1,5)
        ...
        foreach($banksData as $bankData){
            ...
            foreach($bankData['sectors'] as $sector){
                DB::table('bank_sector')->insert([
                    'bank_id' =>  $bank->id,
                    'sector_id' => $sector['id'],
                    'transferred_benefit' => $sector['transferred_benefit'],
                    'non_transferred_benefit' => $sector['non_transferred_benefit'],
