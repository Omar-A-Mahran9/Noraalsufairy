            ...
            <div class="card-header d-flex align-items-center">
                ...
                <div class="card-title">
                    <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                        ...
                        <input class="form-check-input mx-2" style="height: 28px;width:60px;" type="checkbox" name="highlighted_news" id="highlighted-checkbox" @if ( $news['highlighted'] ) checked @endif />
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title_ar" value="{{ $news['title_ar'] }}" placeholder="example" />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title_en" value="{{ $news['title_ar'] }}" placeholder="example" />
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea id="tinymce_description" name="description_ar" class="tinymce"> {!! $news['description_ar'] !!}  </textarea>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea id="tinymce_description" name="description_en" class="tinymce"> {!! $news['description_en'] !!}  </textarea>
