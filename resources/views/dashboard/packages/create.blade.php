            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="card-title">
                    ...
                    <div class="form-check form-check-custom form-check-solid mx-4">
                        ...
                        <input class="form-check-input" type="radio" value="1" name="discount_flag" id="discount-radio-btn" />
                        <label class="form-check-label me-10" for="image-radio-btn"> {{ __("active") }} </label>

                        <input class="form-check-input" type="radio" value="0" name="discount_flag" id="discount-radio-btn" checked />
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="monthly_price_inp" name="monthly_price" placeholder="example" />
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="annual_price_inp" name="annual_price" placeholder="example" />
                            ...
                            <tbody class="text-gray-600 fw-bold text-center ">
                                ...
                                <tr>
                                    <td style="text-align: start;">
                                        <input type="checkbox" class="form-check-input mx-2" data-target="value{{$loop->index }}" style="height: 20px;width:20px;" multiple name="features[]" value="{{ $feature->id }}" id="check-feature">
                                        {{ $feature->name }}
                                        <p class="invalid-feedback" id="features"></p>

                                    </td>
                                    <td class="d-flex justify-content-center">
                                        <input type="number" class="form-control w-25 " name="values[]" multiple disabled id="value{{$loop->index }}">
                ...
                <div class="row mb-10 discount" id="discount" style="display:none">
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="monthly_price_after_discount_inp" name="monthly_price_after_discount" placeholder="example" />
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="annual_price_after_discount_inp" name="annual_price_after_discount" placeholder="example" />
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input class="form-control form-control-solid  datepicker border-gray-300 border-1 filter-datatable-inp me-4" name="discount_from_date" readonly placeholder="{{ __('Choose the start date') }}" data-filter-index="4" />
                        </div>
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input class="form-control form-control-solid  datepicker border-gray-300 border-1 filter-datatable-inp me-4" name="discount_to_date" readonly placeholder="{{ __('Choose the end date') }}" data-filter-index="4" />
                        </div>
