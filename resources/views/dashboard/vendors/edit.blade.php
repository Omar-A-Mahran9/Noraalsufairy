...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.vendors.update',$vendor->id) }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.vendors.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-center">
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$vendor->image" directory="Vendors" placeholder="default.jpg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_inp" name="name" value="{{ $vendor->name }}" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="phone" value="{{ $vendor->phone }}" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="another_phone_inp" name="another_phone" value="{{ $vendor->another_phone }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select"  name="city_id" data-placeholder="{{ __("Choose the city") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}"  >
                                <option value=""></option>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row" style="{{ $vendor->type != 'individual' ? 'display: none;' : '' }}" id="identity_container">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="identity_no_inp" name="identity_no"  value="{{ $vendor->identity_no }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="google_maps_url_inp" name="google_maps_url" value="{{ $vendor->google_maps_url }}" placeholder="example"/>
