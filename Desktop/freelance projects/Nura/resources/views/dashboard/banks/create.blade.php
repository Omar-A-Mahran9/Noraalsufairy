                                ...
                                <div class="col-8 col-form-label">
                                    <div class="radio-inline  d-flex justify-content-start">
                                        <div class="form-check form-check-custom form-check-solid mx-4">
                                            <input class="form-check-input" type="radio" value="1" name="accept_from_other_banks" id="accept_from_other_banks_yes" wtx-context="6ABBB073-FB69-4058-8A50-6B4FFD240797">
                                            <label class="form-check-label" for="accept_from_other_banks_yes">
                                                {{__('Yes')}}
                                            </label>
                                        </div>
                                        <div class="form-check form-check-custom form-check-solid mx-4">
                                            <input class="form-check-input" type="radio" value="0" name="accept_from_other_banks" id="accept_from_other_banks_no" wtx-context="01DAA9FF-73CC-4456-8B56-E4272344A5D0">
