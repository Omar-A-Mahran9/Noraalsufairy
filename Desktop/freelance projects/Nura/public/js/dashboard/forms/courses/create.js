...
$(document).ready(() => {
    ...
    $("#colors-sp").change(function () {
        ...
        if (isAdding) {
            ...
            carColorsDiv.append(`<div class="rounded border border-3 p-5 mb-4" id="color-${lastSelectedColorId}">
                                                ...
                                                <div class="row text-center">
                                                    ...
                                                    <div class="col-md-4 fv-row">
                                                        ...
                                                        <div class="rounded-circle w-80px h-80px m-auto" style="border:1px solid lightslategrey;background:${
                                                            selectedColor[
                                                                "hex_code"
                                                            ] ??
                                                            `url(${getImagePathFromDirectory(
                                                                selectedColor[
                                                                    "image"
                                                                ],
                                                                "Colors"
                                                        ...
                                                        <input type="hidden" name="colors[${currentIndex}][id]" value=${
                selectedColor["id"]
            } >
                                                    </div>
                                                    <!-- end   :: Column -->
                                                    ...
                                                    <div class="col-md-4 fv-row">
                                                        ...
                                                        <label class="text-center fw-bold mb-4 d-block">${__(
                                                            "Outer images"
                                                        )}</label>
                                                        <input type="file" class="d-none" name="colors[${currentIndex}][outer_images][]" multiple id="outer_images_inp_${
                selectedColor["id"]
            }">
                                                        <button class="btn btn-secondary m-auto" type="button" id="outer_images_upload_btn_${
                                                            selectedColor["id"]
                                                        }" > <i class="bi bi-upload fs-8" ></i> 0 ${__(
                "File selected"
            )} </button>
                                                    ...
                                                    <div class="col-md-4 fv-row">
                                                        ...
                                                        <input type="file" class="d-none" name="colors[${currentIndex}][inner_images][]" multiple id="inner_images_inp_${
                selectedColor["id"]
            }">
                                                        <button class="btn btn-secondary m-auto" type="button" id="inner_images_upload_btn_${
                                                            selectedColor["id"]
                                                        }" > <i class="bi bi-upload fs-8" ></i> 0 ${__(
                "File selected"
            )} </button>
            ...
            carColorsDiv
                .find(`[id=color-${lastSelectedColorId}]`)
                .eq(0)
                .remove();
        }
