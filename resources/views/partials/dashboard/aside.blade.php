    ...
    <div class="aside-menu flex-column-fluid">
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                ...
                @canany(['view_brands' , 'view_models' , 'view_colors' , 'view_tags' , 'view_cars','view_features'])
                <!-- begin :: cars section -->
                <div class="menu-item">
                ...
                @can('view_features')
                <div class="menu-item">
                    <a class="menu-link {{ isTabActive('features') }}" href="{{ route('dashboard.features.index') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                            <i class="fa fa-list"></i>
                        </span>
                ...
                @can('view_packages')
                <div class="menu-item">
                    <a class="menu-link {{ isTabActive('packages') }}" href="{{ route('dashboard.packages.index') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                            <i class="fa fa-list"></i>
                        </span>
                ...
                @can('view_vendors')
                <div class="menu-item">
                    <a class="menu-link {{ isTabActive('vendors') }}" href="{{ route('dashboard.vendors.index') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                            <i class="fa fa-users"></i>
                        </span>
            ...
            <div class="menu-item">
                <div class="menu-content pt-8 pb-0">
                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">{{ __("Finance approvals") }}</span>
                </div>
            </div>
            @endcanany
            ...
            <div class="menu-item">
                <a class="menu-link {{ isTabActive('finance-approvals') }}" href="{{ route('dashboard.finance-approvals.index') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon">
            ...
            @can('view_delegates')
            <div class="menu-item">
                <a class="menu-link {{ isTabActive('delegates') }}" href="{{ route('dashboard.delegates.index') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                    <span class="menu-icon">
                        <!-- <i class="fa fa-user-shield"></i> -->
