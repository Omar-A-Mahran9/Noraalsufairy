                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="phone" placeholder="05xxxxxxxx"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="whatsapp_inp" name="whatsapp" placeholder="05xxxxxxxx"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="text-center">
                                <div class="my-3" id="googleMap" style="width: 100%;min-height:300px;border:1px solid #009EF7; border-radius: 10px;">
                                    <!--Google map will be embedded here-->
                                </div>
                                <button class="btn btn-primary text-white mt-10" type="button" onclick="getCurrentPos()">
...
@push('scripts')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDu4T0sSqqn87uvqXHcUbbWpxt4NVyBW6w&callback=myMap&&language=ar&region=EGasync defer"></script>
@endpush
