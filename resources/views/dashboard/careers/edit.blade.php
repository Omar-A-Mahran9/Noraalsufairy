            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_ar_inp" name="title_ar" value="{{ $career['title_ar'] }}" placeholder="example" />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_en_inp" name="title_en" value="{{ $career['title_en'] }}" placeholder="example" />
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select class="form-select" data-control="select2" name="work_type" data-placeholder="{{ __("Choose the work type") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                            <option></option>
                            <option value="full-time" {{$career->work_type == "full-time" ? 'selected':''}}> {{ __("Full-time") }} </option>
                            <option value="part-time" {{$career->work_type == "part-time" ? 'selected':''}}> {{ __("Part-time") }} </option>
                            <option value="remotely" {{$career->work_type == "remotely" ? 'selected':''}}> {{ __("Remotely") }} </option>
                        </select>
