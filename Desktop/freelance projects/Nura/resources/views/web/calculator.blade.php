                            ...
                            {{-- <form action="{{route('home.calculateInstallments')}}"  data-redirection-url="#" method="POST" enctype="multipart/form-data"> --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-3 form-group">
                                        ...
                                        <select class="form-select " name="model_id" id="modelSp">
                                            <option value="" selected="">
                                                {{__('Select the model')}}
                                            </option>
                                    ...
                                    <div class="col-12 col-lg-3 form-group">
                                        ...
                                        <select class="form-select" name="car_id" id="carSp">
                                            <option value="" selected="">
                                                {{__('Select the car')}}
                                            </option>
                                            @foreach ($cars as $car)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6 form-group">
                                        <label for="">{{__('عميل محول ؟')}}</label>
                                        <select class="form-select" name="transferred" id="">
