            ...
            <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="website_name_ar"
                            value="{{ $setting->website_name_ar ?? '' }}" id="website_name_ar_inp"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="website_name_en"
                            value="{{ $setting->website_name_en ?? '' }}" id="website_name_en_inp"
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="facebook_url"
                            value="{{ $setting->facebook_url ?? '' }}" id="facebook_url_inp"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="twitter_url"
                            value="{{ $setting->twitter_url ?? '' }}" id="twitter_url_inp"
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="instagram_url"
                            value="{{ $setting->instagram_url ?? '' }}" id="instagram_url_inp"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="youtube_url"
                            value="{{ $setting->youtube_url ?? '' }}" id="youtube_url_inp"
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="snapchat_url"
                            value="{{ $setting->snapchat_url ?? '' }}" id="snapchat_url_inp"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="email" value="{{ $setting->email ?? '' }}"
                            id="email_inp" placeholder="{{ __('Enter the email') }}">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="phone" value="{{ $setting->phone ?? '' }}"
                            id="phone_inp" placeholder="{{ __('Enter the phone') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="whatsapp"
                            value="{{ $setting->whatsapp ?? '' }}" id="whatsapp_inp"
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="tax" value="{{ $setting->tax ?? '' }}"
                            id="tax_inp" placeholder="{{ __('Enter the tax in percentage') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-12">
                            ...
                            <div class="form-check form-check-custom form-check-solid my-auto">
                                <input class="form-check-input" type="radio" value="1" name="maintenance_mode"
                                    id="active-radio-btn" {{ $setting->maintenance_mode == '1' ? 'checked' : '' }} />
                                ...
                                <input class="form-check-input" type="radio" value="0" name="maintenance_mode"
                                    id="inactive-radio-btn" {{ $setting->maintenance_mode == '0' ? 'checked' : '' }} />
                ...
                <div class="fv-row row mb-15 mt-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="males_insurance"
                            value="{{ $setting->males_insurance ?? 3.75 }}" id="males_insurance_inp"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="females_insurance"
                            value="{{ $setting->females_insurance ?? 6.75 }}" id="females_insurance_inp"
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-secondary w-100 image-upload-inp" type="button"> <i
                                class="bi bi-upload fs-8"></i> {{ $setting->logo ?: __('no file is selected') }}
                        </button>
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-secondary w-100 image-upload-inp" type="button"> <i
                            ...
                            {{ $setting->favicon ?: __('no file is selected') }} </button>
            ...
            <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="slider_dashboard_username"
                            value="{!! $setting->slider_dashboard_username ?? '' !!}" id="slider_dashboard_username_inp"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="slider_dashboard_password"
                            value="{!! $setting->slider_dashboard_password ?? '' !!}" id="slider_dashboard_password_inp"
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" data-control="select2" name="slider_ar"
                            ...
                            {{-- @foreach ($sliders as $slider)
                                <option {{ $setting->slider_ar == $slider->alias ? 'selected' : '' }} value="{{ $slider->alias }}"> {{ $slider->title }} </option>
                            @endforeach --}}
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" data-control="select2" name="slider_en"
                            ...
                            <option value="" selected></option>
                            {{-- @foreach ($sliders as $slider)
                                <option {{ $setting->slider_en == $slider->alias ? 'selected' : '' }} value="{{ $slider->alias }}"> {{ $slider->title }} </option>
                            @endforeach --}}
                        </select>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="home_cars_section_label_ar"
                            value="{!! $setting->home_cars_section_label_ar ?? '' !!}" id="home_cars_section_label_ar_inp"
                            placeholder='{{ __('Enter the home cars section title in arabic') }}'>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="home_cars_section_label_en"
                            value="{!! $setting->home_cars_section_label_en ?? '' !!}" id="home_cars_section_label_en_inp"
                            placeholder='{{ __('Enter the home cars section title in english') }}'>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_purchase_order_text_in_home_page_ar" name="purchase_order_text_in_home_page_ar"
                            class="tinymce">{!! $setting->purchase_order_text_in_home_page_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_purchase_order_text_in_home_page_en" name="purchase_order_text_in_home_page_en"
                            class="tinymce">{!! $setting->purchase_order_text_in_home_page_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_privacy_policy_ar" name="privacy_policy_ar" class="tinymce">{!! $setting->privacy_policy_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_privacy_policy_en" name="privacy_policy_en" class="tinymce">{!! $setting->privacy_policy_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_terms_and_conditions_ar" name="terms_and_conditions_ar" class="tinymce">{!! $setting->terms_and_conditions_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_terms_and_conditions_en" name="terms_and_conditions_en" class="tinymce">{!! $setting->terms_and_conditions_en ?? '' !!}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="about_us_video_url"
                            value="{!! $setting->about_us_video_url ?? '' !!}" id="about_us_video_url_inp"
                            placeholder="{{ __('Enter the video code') }} ( {{ __('ex') }} : deKXbbIHD4w )">
                        <p>{{ __('example') }}: https://www.youtube.com/embed/<span
                                class="text-danger fw-bolder">O6NRLYUThrY</span></p>
                    ...
                    <div class="col-md-6">
                        ...
                        <br>
                        <input type="file" accept="image/*" class="d-none" name="contact_us_section_photo"
                            id="contact_us_section_photo-uploader">
                        <button class="btn btn-secondary w-100 image-upload-inp" type="button"> <i
                                class="bi bi-upload fs-8"></i>
                            {{ $setting->contact_us_section_photo ?: __('no file is selected') }} </button>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <br>
                        <input type="file" accept="image/*" class="d-none" name="purchase_section_photo"
                            id="purchase_section_photo-uploader">
                        <button class="btn btn-secondary w-100 image-upload-inp" type="button"> <i
                                class="bi bi-upload fs-8"></i>
                            {{ $setting->purchase_section_photo ?: __('no file is selected') }} </button>
                    ...
                    <div class="col-md-6">
                        ...
                        <button class="btn btn-secondary w-100 image-upload-inp" type="button"> <i
                                class="bi bi-upload fs-8"></i>
                            {{ $setting->who_code_car_photo ?: __('no file is selected') }} </button>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_about_us_ar" name="about_us_ar" class="tinymce">{!! $setting->about_us_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_about_us_en" name="about_us_en" class="tinymce">{!! $setting->about_us_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_ar" name="why_code_car_cars_ar" class="tinymce">{!! $setting->why_code_car_cars_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_en" name="why_code_car_cars_en" class="tinymce">{!! $setting->why_code_car_cars_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_1_ar" name="why_code_car_cars_card_1_ar" class="tinymce">{!! $setting->why_code_car_cars_card_1_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_1_en" name="why_code_car_cars_card_1_en" class="tinymce">{!! $setting->why_code_car_cars_card_1_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_2_ar" name="why_code_car_cars_card_2_ar" class="tinymce">{!! $setting->why_code_car_cars_card_2_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_2_en" name="why_code_car_cars_card_2_en" class="tinymce">{!! $setting->why_code_car_cars_card_2_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_3_ar" name="why_code_car_cars_card_3_ar" class="tinymce">{!! $setting->why_code_car_cars_card_3_ar ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_3_en" name="why_code_car_cars_card_3_en" class="tinymce">{!! $setting->why_code_car_cars_card_3_en ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control form-control form-control" name="footer_text_ar" id="footer_text_ar_inp"
                            data-kt-autosize="true">{{ $setting->footer_text_ar ?? '' }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control form-control form-control" name="footer_text_en" id="footer_text_en_inp"
                            data-kt-autosize="true">{{ $setting->footer_text_en ?? '' }}</textarea>
