                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-12 fv-row d-flex justify-content-evenly">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <x-dashboard.upload-image-inp name="cover_image" :image="$news['highlighted_image']" directory="News" placeholder="default.jpg" type="show"></x-dashboard.upload-image-inp>
