...
<div class="card">
    ...
    <div class="card-body p-0">
        <!-- begin :: Form -->
        <form action="{{ route('dashboard.delegates.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.delegates.index') }}">
            @csrf
            <!-- begin :: Card header -->
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="commission_inp" name="commission" placeholder="example" />
