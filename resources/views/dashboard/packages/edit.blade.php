            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <div class="card-title">
                    ...
                    <div class="form-check form-check-custom form-check-solid mx-4">
                        ...
                        <input class="form-check-input" type="radio" value="1" name="discount_flag" {{$package->monthly_price_after_discount ? 'checked':''}} />
                        <label class="form-check-label me-10" for="image-radio-btn"> {{ __("active") }} </label>

                        <input class="form-check-input" type="radio" value="0" name="discount_flag" {{$package->monthly_price_after_discount ? '':'checked'}} />
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <input type="text" class="form-control" id="name_ar_inp" name="name_ar" value="{{ $package->name_ar }}" />
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <input type="text" class="form-control" id="name_en_inp" name="name_en" value="{{ $package->name_en }}" />
                ...
                <div class="row mb-10 discount" id="discount" style="{{$package->monthly_price_after_discount ? '' :'display:none'}}">

                    <!-- begin :: Column -->
                    <div class="col-md-3 fv-row">
                        <label class="fs-5 fw-bold mb-2">{{ __("Monthly price after discount") }}</label>
                        <div class="form-floating">
                            <input type="text" class="form-control" id="monthly_price_after_discount_inp" name="monthly_price_after_discount" value="{{ $package->monthly_price_after_discount }}" placeholder="example" />
                            <label for="monthly_price_after_discount_inp">{{ __("Enter the monthly price after discount") }}</label>
                        </div>
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="annual_price_after_discount_inp" name="annual_price_after_discount" value="{{ $package->annual_price_after_discount }}" placeholder="example" />
                            <label for="annual_price_after_discount_inp">{{ __("Enter the annual price after discount") }}</label>
                        </div>
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input class="form-control form-control-solid datepicker border-gray-300 border-1 me-4" id="discountFromDate" name="discount_from_date" readonly placeholder="{{ __('Choose the start date') }}" />
                        </div>
                    ...
                    <div class="col-md-3 fv-row">
                        ...
                        <div class="form-floating">
                            <input class="form-control form-control-solid datepicker border-gray-300 border-1 me-4" id="discountToDate" name="discount_to_date" readonly placeholder="{{ __('Choose the end date') }}" />
                        </div>
                    ...
                    <div class="col-md-6 fv-row " style="overflow: scroll;height: 284px;width: 100%;">
                        <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5 ">
                            ...
                            <tbody class="text-gray-600 fw-bold text-center">
                                ...
                                $featurePackage = $isFeatureInPackage ? current(array_filter($packageFeaturesArray, function($item) use ($feature) {
                                return $item['feature_id'] === $feature->id;
                                })) : null;
                                @endphp
                                <tr>
                                    <td style="text-align: start;">
                                        <input type="checkbox" class="form-check-input mx-2" data-target="value{{ $loop->index }}" style="height: 20px;width:20px;" multiple name="features[]" value="{{ $feature->id }}" id="check-feature{{ $loop->index }}" {{ $isFeatureInPackage ? 'checked' : '' }}>
                                        {{ $feature->name }}
                                        <p class="invalid-feedback" id="features"></p>
                                    </td>
                                    <td class="d-flex justify-content-center">
                                        <input type="number" class="form-control w-25" value="{{ $featurePackage ? $featurePackage['value'] : '' }}" name="values[]" multiple id="value{{ $loop->index }}" {{ $isFeatureInPackage ? '' : 'disabled' }}>
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea id="tinymce_description_ar" name="description_ar" class="tinymce">{!! $package->description_ar !!}</textarea>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea id="tinymce_description_en" name="description_en" class="tinymce">{!! $package->description_en !!}</textarea>
