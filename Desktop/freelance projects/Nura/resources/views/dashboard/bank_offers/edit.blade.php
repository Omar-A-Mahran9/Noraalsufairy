...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <form action="{{ route('dashboard.bank-offers.update',$bankOffer->id) }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.banks.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-20">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$bankOffer->image" directory="BankOffers" placeholder="default.jpg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_ar_inp" name="title_ar"  value="{{$bankOffer->title_ar??''}}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_en_inp" name="title_en" value="{{$bankOffer->title_en??''}}" placeholder="example"/>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea id="tinymce_description_ar" name="description_ar"  class="tinymce">{!! $bankOffer->description_ar ?? '' !!}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea id="tinymce_description_en" name="description_en" class="tinymce">{!! $bankOffer->description_en ?? '' !!}</textarea>
                    ...
                    <div class="row mb-10">
                        <div class="col-md-6 fv-row">
                            ...
                            <input name="from" value="{{$bankOffer->from}}" class="form-control form-control-solid ms-4 datepicker border-gray-300 border-1 filter-datatable-inp me-4" readonly placeholder="{{ __('Choose the date') }}" data-filter-index="6" />
                            <p class="invalid-feedback" id="from" ></p>
                        </div>
                        <div class="col-md-6 fv-row">
                            <label class="fs-5 fw-bold mb-2">{{ __("Date to") }}</label>
                            <input name="to" value="{{$bankOffer->to}}" class="form-control form-control-solid ms-4 datepicker border-gray-300 border-1 filter-datatable-inp me-4" readonly placeholder="{{ __('Choose the date') }}" data-filter-index="6" />
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select"  name="bank_id" id="bank-sp" data-placeholder="{{ __("Choose the bank") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select" multiple data-control="select2" name="brand_id[]" id="brand-sp" data-placeholder="{{ __("Choose the brand") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                @foreach( $brands as $brand)
                                    <option @if(in_array($brand->id,$selectedBrandIds)) selected @endif value="{{ $brand->id }}"> {{ $brand->name }} </option>
                                @endforeach
                            </select>
                    ...
                    @foreach($bankOffer->sectors as $sector)
                    @php
                        $pivot = $sector->pivot;
                    @endphp
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input style="direction: {{ isArabic() ? 'rtl' : '' }}" type="text" class="form-control" id="{{$bankSector->slug}}_transferred_benefit_inp" name="{{$bankSector->slug}}[transferred_benefit]"  value="{{$bankSector['pivot']['transferred_benefit']}}" placeholder="example"/>
                                <label for="transferred_benefit_inp">{{ __("Enter the transferred client profit") }}</label>
                            </div>
                            <p class="invalid-feedback" id="{{$bankSector->slug}}_transferred_benefit" ></p>
                        </div>
                        <!-- end   :: Column -->
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input style="direction: ltr" type="input" class="form-control" id="{{$slug}}_support_inp" name="{{$slug}}[support]" value="{{$bankSector['pivot']['support']}}" placeholder="example"/>
                        ...
                        <div class="col-md-3 fv-row">
                            ...
                            <div class="form-floating">
                                <input style="direction: ltr" type="input" class="form-control" id="{{$bankSector->slug}}_administrative_fees"  value="{{$bankSector['pivot']['administrative_fees']}}" name="{{$bankSector->slug}}[administrative_fees]" placeholder="example"/>
