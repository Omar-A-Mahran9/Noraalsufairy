        ...
        <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="tax" value="{{ settings()->get('tax') ?? '' }}" id="tax_inp" placeholder="{{ __("Enter the tax in percentage") }}">
                ...
                <div class="fv-row row mb-15 mt-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="males_insurance" value="{{ settings()->get('males_insurance') ?? 3.75 }}" id="males_insurance_inp" placeholder="{{ __("Enter the males insurance in percentage") }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="females_insurance" value="{{ settings()->get('females_insurance') ?? 6.75 }}" id="females_insurance_inp" placeholder="{{ __("Enter the females insurance in percentage") }}">
                                    ...
                                    @forelse( $statuses as $status)
                                        <div data-repeater-item>
                                            ...
                                            <div class="form-group row mt-5">
                                                ...
                                                <div class="col-md-2">
                                                    <label class="form-label" >{{ __("Message in arabic") }}</label>
                                                    <textarea class="form-control mb-2 mb-md-0" name="message_ar" placeholder="{{ __("Enter status message in arabic") }}" {{ $loop->first ? 'readonly'  : '' }} rows="5">{{ $status['message_ar'] }}</textarea>
                                                    <p class="invalid-feedback" id="orders_statuses_{{ $loop->index }}_message_ar" ></p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __("Message in english") }}</label>
                                                    <textarea class="form-control mb-2 mb-md-0" name="message_en" placeholder="{{ __("Enter status message in english") }}" {{ $loop->first ? 'readonly'  : '' }} rows="5">{{ $status['message_en'] }}</textarea>
                                                    <p class="invalid-feedback" id="orders_statuses_{{ $loop->index }}_message_en" ></p>
                                                </div>
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-1 mt-10 text-center">
                                    ...
                                    @empty
                                        <div data-repeater-item>
                                            <div class="form-group row mt-5">
                                                ...
                                                <div class="col-md-2">
                                                    <label class="form-label" >{{ __("Message in arabic") }}</label>
                                                    <textarea class="form-control mb-2 mb-md-0" name="message_ar" placeholder="{{ __("Enter status message in arabic") }}" rows="5"></textarea>
                                                    <p class="invalid-feedback" id="orders_statuses_0_message_ar" ></p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __("Message in english") }}</label>
                                                    <textarea class="form-control mb-2 mb-md-0" name="message_en" placeholder="{{ __("Enter status message in english") }}" rows="5"></textarea>
                                                    <p class="invalid-feedback" id="orders_statuses_0_message_en" ></p>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">{{ __("status color") }}</label>
                                                ...
                                                <div class="col-md-1 mt-10 text-center">
                                                    <label class="form-check form-check-sm form-check-custom form-check-solid">
                                                        <label class="form-label fs-4">{{ __('active ?') }}</label>
                                                        <input class="form-check-input ms-3" type="checkbox" name="is_active" >
                                                    </label>
                                                </div>
                                                <div class="col-md-1 text-center">
                                                    <a href="javascript:" data-repeater-delete class="btn btn-sm btn-light-danger mt-4 mt-md-9">
    ...
    <div class="card card-flush setting-card" style="display:none" id="about-website-settings-card">
        ...
        <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <br>
                    <input type="file" accept="image/*" class="d-none" name="who_code_car_photo" id="who_code_car_photo-uploader">
                    <button class="btn btn-secondary w-100 image-upload-inp" type="button" > <i class="bi bi-upload fs-8" ></i> {{ settings()->get('who_code_car_photo') ?:  __("no file is selected")   }} </button>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_ar" name="why_code_car_cars_ar" class="tinymce">{!! settings()->get('why_code_car_cars_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_en" name="why_code_car_cars_en" class="tinymce">{!! settings()->get('why_code_car_cars_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_1_ar" name="why_code_car_cars_card_1_ar" class="tinymce">{!! settings()->get('why_code_car_cars_card_1_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_1_en" name="why_code_car_cars_card_1_en" class="tinymce">{!! settings()->get('why_code_car_cars_card_1_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_2_ar" name="why_code_car_cars_card_2_ar" class="tinymce">{!! settings()->get('why_code_car_cars_card_2_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_2_en" name="why_code_car_cars_card_2_en" class="tinymce">{!! settings()->get('why_code_car_cars_card_2_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_3_ar" name="why_code_car_cars_card_3_ar" class="tinymce">{!! settings()->get('why_code_car_cars_card_3_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tinymce_why_code_car_cars_card_3_en" name="why_code_car_cars_card_3_en" class="tinymce">{!! settings()->get('why_code_car_cars_card_3_en') ?? '' !!}</textarea>
